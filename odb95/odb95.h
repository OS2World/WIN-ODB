...
#define DEFAULTHELPURL		"http:\/\/www.shopline.com.au/odb/odbdoc.htm"
...
#define MAXVALUELENGTH		1024
#define MAXOBJTEXTLENGTH       2048
...
public:
   ...
   virtual LONG processMessages(HWND hWndThis,UINT message, WPARAM wParam, 
				LPARAM lParam);
...
public:
   LONG processMessages(HWND hWndThis,UINT message, WPARAM wParam, 
   LPARAM lParam);
   DlgModal *getDlg(void);
   void setDlg(DlgModal *dlg){currentDlg=dlg;};
   virtual database *getDb(void);
